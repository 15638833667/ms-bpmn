/*
  ...
  return fetch('https://api.github.com/repos/themusecatcher/ms-bpmn/contents/package.json?ref=master', {
    headers: {
  ...
  return fetch('https://raw.githubusercontent.com/themusecatcher/ms-bpmn/master/package.json')
*/
