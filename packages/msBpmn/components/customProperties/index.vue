<template>
  <div class="custom-bpmn-panel">
    <el-input v-model="id" readonly @change="nameChange" placeholder="流程ID"></el-input>
    <el-input v-model="name" @change="nameChange" placeholder="请输入流程名称"></el-input>
